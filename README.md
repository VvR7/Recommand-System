...
| 方法 | GAUC | Recall@5 | Recall@10 | Recall@20 | NDCG@5 | NDCG@10 | NDCG@20 | 类型 | 特征 |
|------|------|----------|-----------|-----------|--------|---------|---------|------|------|
| **🥇 SASRecF** | **0.8509** | **0.4449** | **0.5955** | **0.7538** | **0.3062** | **0.3550** | **0.3950** | 单向 Transformer | +item cat |
| **🥈 SASRec** | **0.8249** | **0.4200** | **0.5610** | **0.7094** | **0.2948** | **0.3404** | **0.3779** | 单向 Transformer | ID-only | 
| **🥉 BERT4Rec** | **0.8217** | **0.3882** | **0.5274** | **0.6858** | **0.2662** | **0.3112** | **0.3511** | 双向 Transformer | ID-only |
| 4. DeepFM+Feat | 0.7067 | 0.1636 | 0.2989 | 0.4825 | 0.0965 | 0.1399 | 0.1863 | FM+MLP | user+item cat | 
| 5. DeepFM | 0.6758 | 0.1572 | 0.2843 | 0.4613 | 0.0936 | 0.1343 | 0.1789 | FM+MLP | ID-only | 
| 6. NeuMF | 0.6480 | 0.1297 | 0.2417 | 0.4118 | 0.0762 | 0.1120 | 0.1548 | GMF+MLP | ID-only | 
| 7. BPR | 0.6389 | 0.1436 | 0.2501 | 0.3951 | 0.0859 | 0.1201 | 0.1565 | 矩阵分解 | ID-only | 
| 8. ItemKNN | 0.5525 | 0.1413 | 0.2316 | 0.3432 | 0.0859 | 0.1149 | 0.1430 | 协同过滤 | ID-only | 
